...
- Individual incidents: one pin per returned crime record. Multiple records can share the same anonymised Police.uk location, so individual pin names include the Police.uk record id.
